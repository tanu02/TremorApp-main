...
export default class NonDominantIndexFinger extends Component {
  constructor(props) {
    super(props);
    this.state = {
      correct: 0,
  ...
  storeData(){
    ...
    firebase.database().ref('users/'+this.props.Patient+'/'+this.props.Date+'/Bradykinesia/NonDominantIndexFinger/Red/Time').set(global.myArray);
    firebase.database().ref('users/'+this.props.Patient+'/'+this.props.Date+'/Bradykinesia/NonDominantIndexFinger/Green/Time').set(global.myArra);
    firebase.database().ref('users/'+this.props.Patient+'/'+this.props.Date+'/Bradykinesia/NonDominantIndexFinger/Red/Position').set(global.XYRed);
    firebase.database().ref('users/'+this.props.Patient+'/'+this.props.Date+'/Bradykinesia/NonDominantIndexFinger/Green/Position').set(global.XYGreen);
    var year = new Date().getFullYear();
    var week = currentWeekNumber();
    firebase.database().ref('users/'+this.props.Patient+'/'+year+'/'+week+'/Bradykinesia/NonDominantIndexFinger/State').set('Done');
    this.setState({
      buttonText: 'Redo'
    })
