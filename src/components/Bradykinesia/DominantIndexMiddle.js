...
export default class DominantIndexMiddle extends Component {
  constructor(props) {
    super(props);
    this.state = {
      correct: 0,
  ...
  storeData(){
    ...
    firebase.database().ref('users/'+this.props.Patient+'/'+this.props.Date+'/Bradykinesia/DominantIndexMiddle/Red/Time').set(global.myArray);
    firebase.database().ref('users/'+this.props.Patient+'/'+this.props.Date+'/Bradykinesia/DominantIndexMiddle/Green/Time').set(global.myArra);
    firebase.database().ref('users/'+this.props.Patient+'/'+this.props.Date+'/Bradykinesia/DominantIndexMiddle/Red/Position').set(global.XYRed);
    firebase.database().ref('users/'+this.props.Patient+'/'+this.props.Date+'/Bradykinesia/DominantIndexMiddle/Green/Position').set(global.XYGreen);
    var year = new Date().getFullYear();
    var week = currentWeekNumber();
    firebase.database().ref('users/'+this.props.Patient+'/'+year+'/'+week+'/Bradykinesia/DominantIndexMiddle/State').set('Done');
    this.setState({
      buttonText: 'Redo'
    })
