...
export default class DualIndex extends Component {
  constructor(props) {
    super(props);
    this.state = {
      correct: 0,
  ...
  storeData(){
    ...
    firebase.database().ref('users/'+this.props.Patient+'/'+this.props.Date+'/Bradykinesia/DualIndex/Red/Time').set(global.myArray);
    firebase.database().ref('users/'+this.props.Patient+'/'+this.props.Date+'/Bradykinesia/DualIndex/Green/Time').set(global.myArra);
    firebase.database().ref('users/'+this.props.Patient+'/'+this.props.Date+'/Bradykinesia/DualIndex/Red/Position').set(global.XYRed);
    firebase.database().ref('users/'+this.props.Patient+'/'+this.props.Date+'/Bradykinesia/DualIndex/Green/Position').set(global.XYGreen);
    var year = new Date().getFullYear();
    var week = currentWeekNumber();
    firebase.database().ref('users/'+this.props.Patient+'/'+year+'/'+week+'/Bradykinesia/DualIndex/State').set('Done');
    this.setState({
      buttonText: 'Redo'
    })
